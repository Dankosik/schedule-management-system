...
update students
set first_name    = 'Ferdinanda',
    last_name     = 'Casajuana',
    middle_name   = 'Lambarton',
    course_number = 1,
    group_id      = 1000,
    faculty_id    = 1000,
    university_id = 1000
...
where id = 1000;
update teachers
set first_name    = 'Lynsey',
    last_name     = 'Grzeszczak',
    middle_name   = 'McPhillimey',
    student_id    = 1001,
    university_id = 1000
where id = 1001;
...
update departments
set name          = 'Department of Automation and System Engineering',
    faculty_id    = 1000,
    university_id = 1000
WHERE id = 1000;
update departments
set name          = 'Department of Higher Mathematics',
    faculty_id    = 1001,
    university_id = 1000
WHERE id = 1001;
