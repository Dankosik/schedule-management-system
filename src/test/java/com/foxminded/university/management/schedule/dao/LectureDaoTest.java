...
class LectureDaoTest extends BaseDaoTest {
    ...
    void shouldCreateNewLecture() {
        Lecture lecture = new Lecture(111, Date.valueOf(LocalDate.of(2020, 1, 1)), 1000L, 1000L, 1000L);
        ...
        Lecture actual = new Lecture((Integer) map.get("number"), (Date) map.get("date"), (Long) map.get("audience_id"),
                (Long) map.get("lesson_id"), (Long) map.get("teacher_id"));
        assertEquals(lecture, actual);
    }

    @Test
    void shouldUpdateLecture() {
        Lecture lecture = new Lecture(1000L, 111, Date.valueOf(LocalDate.of(2020, 1, 1)), 1000L, 1000L, 1000L);
        Long lectureId = lectureDao.save(lecture).getId();
        assertTrue(testUtils.existsById("lectures", lectureId));

        Map<String, Object> map = testUtils.getEntry("lectures", lectureId);
        Lecture actual = new Lecture((Long) map.get("id"), (Integer) map.get("number"), (Date) map.get("date"),
                (Long) map.get("audience_id"), (Long) map.get("lesson_id"), (Long) map.get("teacher_id"));
        assertEquals(lecture, actual);
    }

    @Test
    void shouldReturnLectureWithIdOne() {
        Lecture expected = new Lecture(1000L, 1, Date.valueOf(LocalDate.of(2021, 1, 1)), 1000L, 1000L, 1000L);
    ...
    void shouldReturnListOfLecture() {
        List<Lecture> expected = List.of(
                new Lecture(1000L, 1, Date.valueOf(LocalDate.of(2021, 1, 1)), 1000L, 1000L, 1000L),
                new Lecture(1001L, 2, Date.valueOf(LocalDate.of(2021, 1, 1)), 1001L, 1001L, 1001L),
                new Lecture(1002L, 3, Date.valueOf(LocalDate.of(2021, 1, 1)), 1002L, 1002L, 1000L),
                new Lecture(1003L, 4, Date.valueOf(LocalDate.of(2021, 2, 1)), 1003L, 1003L, 1001L));
    ...
    void shouldSaveListOfLectures() {
        List<Lecture> lectures = List.of(
                new Lecture(222, Date.valueOf(LocalDate.of(2021, 1, 1)), 1000L, 1000L, 1000L),
                new Lecture(223, Date.valueOf(LocalDate.of(2021, 1, 2)), 1001L, 1001L, 1001L));
        ...
        List<Lecture> expected = List.of(
                ...
                new Lecture(1002L, 3, Date.valueOf(LocalDate.of(2021, 1, 1)), 1002L, 1002L, 1000L),
                new Lecture(1003L, 4, Date.valueOf(LocalDate.of(2021, 2, 1)), 1003L, 1003L, 1001L),
                new Lecture(1L, 222, Date.valueOf(LocalDate.of(2021, 1, 1)), 1000L, 1000L, 1000L),
                new Lecture(2L, 223, Date.valueOf(LocalDate.of(2021, 1, 2)), 1001L, 1001L, 1001L));
